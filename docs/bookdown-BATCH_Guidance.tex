...
\item
  ...
  variables required for calculation, recommend for calculation, and
  needed for the real life application examples (found in Chapter 5).
  While this data set was model on the response rates of the 2013/2014
  CCHS PUMF (e.g.~approximately 80\% of responders did not have high
  blood pressure (CCC\_071)), the data is fabricated and random. It
  \textbf{cannot be used for real analysis}.
\end{itemize}
...
\item
  ...
  counterfactual population were always never smokers.
\item
  \textbf{Cause-deleted effect on life expectancy} or \textbf{life years
  lost due to the cause} is the full effect of the cause (e.g.~smoking)
  in the population. For instance, 3 years of life are lost in a
...
\item
  ...
  effects
\item
  cause-deleted effect on life expectancy (or life years lost due to the
  cause) is calculated for each individual cause. There will be both the
  cause-deleted effect of smoking on life expectancy and cause-deleted
...
counterfactual populations for each of the health behaviours in the
...
healht surveys with self-reported data to predict risk and health
outcomes. With self-reported surveys there is the possiblitiy of social
desirability bias, where respondents over-report what they percieve to
be healthy behaviours and under-report what they percieve to be
...
\caption{Risk portion of the cause-deleted calculations}\label{fig:unnamed-chunk-15}
\end{figure}
