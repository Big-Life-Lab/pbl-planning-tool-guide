...
-   [Data and sample files](#dataandsamplefiles)
...
*How would life expectancy change if everyone increased their physical activity levels by 10%?* *What if Canadians never smoked?*

You are likely thinking about a scenario if you start your sentence with "what if..." or "how would...". In the planning tool, a scenario allows you to calculate an outcome by changing a risk factor or a combination of risk factors.

::: {.AOO}
**scenario** noun [ C ] UK /sɪˈnɑː.ri.əʊ/ US /səˈner.i.oʊ/

A description of possible actions or events in the future.

[Cambridge Dictionary](https://dictionary.cambridge.org/dictionary/english/scenario)
:::

There are two types of scenarios that can be calucated in the planning tool:

-   [Interventions](#intervetions) - that calculate a health outcome by modifing or changing health behaviour(s).
-   [Attributable fraction in the population](#afp) - that calculate a helath outcome under the scenario that no one in the population ever smoked. Attributable fraction in the poulation is known under many terms, including 'popuation attributable risk'. An example is the commonly used term 'smoking attributable mortalty'.
...
::: {.FOO}
**Note:** $\text{SMK and inPA - deleted outcome} \neq$ $\text{SMK attributable outcome} + \text{inPA attributable outcome}$
