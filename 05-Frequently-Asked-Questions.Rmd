...
Population predictive risk algorithms predict the future risk of health outcomes (e.g. Life Expectancy) for a population using routinely collected health data.

Population predictive risk algorithms can be used to:
...
More information on what population predictive risk algorithms are and how they can be used can be found the journal article: Predictive risk algorithms in a population setting: an overview [@PoRTover]

**4.1.1 Development of predictive risk models**

**Data:**

-	Population predictive risk models are created using routinely collected data that includes information about risk factors (exposure) and health events (outcomes).
...
- Predictive risk models are developed and validated in 4 stages:
...
**4.1.2 Predictive risk algorithms in Project Big Life Planning Tool**

- There is currently 1 predictive risk model is built into to Project Big Life planning tool.
