...
The Project Big Life Planning Tool was developed in order to support public health practitioners in thier: research, planning, development and decision making of evidence-based policy.
...
- More information about population predictive risk algorithms can be found in the reference section (Chapter \@ref(references).
...
- It is **easy** and **flexible** to use. 
    ...
    - It can be used to assess the effect of different intervention scenarios (e.g. policy) on a health outcome.
    
    
-	It generates **accurate** predictions.

    - It can be used to accurately assess the risk of a health outcome in different populations, and groups of people that account for a fraction of the population. 

    
-	It is **Private**. 

    - Uploaded data remains on your computer and are not uploaded or sent anywhere.
